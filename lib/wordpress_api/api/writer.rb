module WordpressApi
  module Api
    ...
    module Writer
      ...
      def create_post blog_id, content, params={}
        path = "sites/#{blog_id}/posts/new"
        Mash.new(post(path, content.to_json, params))
      end
      ...
      def create_comment blog_id, post_id, content, params={}
        path = "sites/#{blog_id}/posts/#{post_id}/replies/new"
        Mash.new(post path, content.to_json, params)
      end

      def create_comment_tree blog_id, comment_id, content, params={}
